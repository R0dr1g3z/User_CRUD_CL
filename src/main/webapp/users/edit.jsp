        ...
        <div class="card-body">
            <form method="post" class="user">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user" placeholder="${user.username}"
                        name="username" id="username">
                    <label class="m-2">
                        Email
                    </label>
                    <input type="email" class="form-control form-control-user" placeholder="${user.email}" name="email"
                        id="email">
                    <label class="m-2">
                        Password
                    </label>
